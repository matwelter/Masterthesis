...
static void initialize_c3_Inversion(SFc3_InversionInstanceStruct *chartInstance);
static void initialize_params_c3_Inversion(SFc3_InversionInstanceStruct
  *chartInstance);
static void enable_c3_Inversion(SFc3_InversionInstanceStruct *chartInstance);
static void disable_c3_Inversion(SFc3_InversionInstanceStruct *chartInstance);
static void c3_update_debugger_state_c3_Inversion(SFc3_InversionInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c3_Inversion(SFc3_InversionInstanceStruct
  *chartInstance);
static void set_sim_state_c3_Inversion(SFc3_InversionInstanceStruct
  *chartInstance, const mxArray *c3_st);
static void finalize_c3_Inversion(SFc3_InversionInstanceStruct *chartInstance);
static void sf_c3_Inversion(SFc3_InversionInstanceStruct *chartInstance);
static void initSimStructsc3_Inversion(SFc3_InversionInstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c3_machineNumber, uint32_T
  c3_chartNumber);
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData);
static void c3_emlrt_marshallIn(SFc3_InversionInstanceStruct *chartInstance,
  const mxArray *c3_y, const char_T *c3_identifier, real_T c3_b_y[3]);
static void c3_b_emlrt_marshallIn(SFc3_InversionInstanceStruct *chartInstance,
  const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId, real_T c3_y[3]);
static void c3_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static const mxArray *c3_b_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static real_T c3_c_emlrt_marshallIn(SFc3_InversionInstanceStruct *chartInstance,
  const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static void c3_info_helper(c3_ResolvedFunctionInfo c3_info[17]);
static real_T c3_mpower(SFc3_InversionInstanceStruct *chartInstance, real_T c3_a);
static void c3_eml_error(SFc3_InversionInstanceStruct *chartInstance);
static void c3_b_eml_error(SFc3_InversionInstanceStruct *chartInstance);
static const mxArray *c3_c_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static int32_T c3_d_emlrt_marshallIn(SFc3_InversionInstanceStruct *chartInstance,
  const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static uint8_T c3_e_emlrt_marshallIn(SFc3_InversionInstanceStruct *chartInstance,
  const mxArray *c3_b_is_active_c3_Inversion, const char_T *c3_identifier);
static uint8_T c3_f_emlrt_marshallIn(SFc3_InversionInstanceStruct *chartInstance,
  const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void init_dsm_address_info(SFc3_InversionInstanceStruct *chartInstance);
...
static void initialize_c3_Inversion(SFc3_InversionInstanceStruct *chartInstance)
{
  ...
  chartInstance->c3_is_active_c3_Inversion = 0U;
}
  ...
  *chartInstance)
{
  ...
  c3_hoistedGlobal = chartInstance->c3_is_active_c3_Inversion;
  ...
  *chartInstance, const mxArray *c3_st)
{
  ...
  chartInstance->c3_is_active_c3_Inversion = c3_e_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c3_u, 1)), "is_active_c3_Inversion");
  sf_mex_destroy(&c3_u);
  c3_update_debugger_state_c3_Inversion(chartInstance);
...
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData)
{
  ...
  real_T c3_u[3];
  const mxArray *c3_y = NULL;
  SFc3_InversionInstanceStruct *chartInstance;
  chartInstance = (SFc3_InversionInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c3_Inversion_get_eml_resolved_functions_info(void)
{
  ...
  const mxArray *c3_b_is_active_c3_Inversion, const char_T *c3_identifier)
{
  ...
  c3_y = c3_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c3_b_is_active_c3_Inversion), &c3_thisId);
  sf_mex_destroy(&c3_b_is_active_c3_Inversion);
  return c3_y;
}
...
/* SFunction Glue Code */
void sf_c3_Inversion_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c3_Inversion_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c3_Inversion(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c3_Inversion\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c3_Inversion_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc3_InversionInstanceStruct *chartInstance;
    chartInstance = (SFc3_InversionInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c3_Inversion(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc3_InversionInstanceStruct*) chartInstanceVar
    )->S,0);
  initialize_params_c3_Inversion((SFc3_InversionInstanceStruct*)
    chartInstanceVar);
  initialize_c3_Inversion((SFc3_InversionInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c3_Inversion(void *chartInstanceVar)
{
  enable_c3_Inversion((SFc3_InversionInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c3_Inversion(void *chartInstanceVar)
{
  disable_c3_Inversion((SFc3_InversionInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c3_Inversion(void *chartInstanceVar)
{
  sf_c3_Inversion((SFc3_InversionInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c3_Inversion(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c3_Inversion((SFc3_InversionInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c3_Inversion();/* state var info */
...
extern void sf_internal_set_sim_state_c3_Inversion(SimStruct* S, const mxArray
  *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c3_Inversion((SFc3_InversionInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c3_Inversion(SimStruct* S)
{
  return sf_internal_get_sim_state_c3_Inversion(S);
}

static void sf_opaque_set_sim_state_c3_Inversion(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c3_Inversion(S, st);
}

static void sf_opaque_terminate_c3_Inversion(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc3_InversionInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c3_Inversion((SFc3_InversionInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc3_Inversion((SFc3_InversionInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c3_Inversion(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c3_Inversion(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c3_Inversion(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c3_Inversion(SimStruct *S)
{
  SFc3_InversionInstanceStruct *chartInstance;
  chartInstance = (SFc3_InversionInstanceStruct *)malloc(sizeof
    (SFc3_InversionInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc3_InversionInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c3_Inversion;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c3_Inversion;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c3_Inversion;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c3_Inversion;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c3_Inversion;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c3_Inversion;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c3_Inversion;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c3_Inversion;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c3_Inversion;
  chartInstance->chartInfo.mdlStart = mdlStart_c3_Inversion;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c3_Inversion;
...
void c3_Inversion_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c3_Inversion(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c3_Inversion(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c3_Inversion(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c3_Inversion_method_dispatcher.\n"
