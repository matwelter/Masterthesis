...
static void initialize_c2_gesamtmodell(SFc2_gesamtmodellInstanceStruct
  *chartInstance);
static void initialize_params_c2_gesamtmodell(SFc2_gesamtmodellInstanceStruct
  *chartInstance);
static void enable_c2_gesamtmodell(SFc2_gesamtmodellInstanceStruct
  *chartInstance);
static void disable_c2_gesamtmodell(SFc2_gesamtmodellInstanceStruct
  *chartInstance);
static void c2_update_debugger_state_c2_gesamtmodell
  (SFc2_gesamtmodellInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_gesamtmodell
  (SFc2_gesamtmodellInstanceStruct *chartInstance);
static void set_sim_state_c2_gesamtmodell(SFc2_gesamtmodellInstanceStruct
  *chartInstance, const mxArray *c2_st);
static void finalize_c2_gesamtmodell(SFc2_gesamtmodellInstanceStruct
  *chartInstance);
...
static void c2_chartstep_c2_gesamtmodell(SFc2_gesamtmodellInstanceStruct
  *chartInstance);
static void initSimStructsc2_gesamtmodell(SFc2_gesamtmodellInstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static void c2_emlrt_marshallIn(SFc2_gesamtmodellInstanceStruct *chartInstance,
...
static const mxArray *c2_c_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static real_T c2_c_emlrt_marshallIn(SFc2_gesamtmodellInstanceStruct
...
static void c2_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static void c2_eml_scalar_eg(SFc2_gesamtmodellInstanceStruct *chartInstance);
static const mxArray *c2_e_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_e_emlrt_marshallIn(SFc2_gesamtmodellInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static uint8_T c2_f_emlrt_marshallIn(SFc2_gesamtmodellInstanceStruct
  *chartInstance, const mxArray *c2_b_is_active_c2_gesamtmodell, const char_T
  *c2_identifier);
static uint8_T c2_g_emlrt_marshallIn(SFc2_gesamtmodellInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void init_dsm_address_info(SFc2_gesamtmodellInstanceStruct *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_gesamtmodell = 0U;
}
  ...
  (SFc2_gesamtmodellInstanceStruct *chartInstance)
{
  ...
  c2_hoistedGlobal = chartInstance->c2_is_active_c2_gesamtmodell;
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_y = NULL;
  SFc2_gesamtmodellInstanceStruct *chartInstance;
  chartInstance = (SFc2_gesamtmodellInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c2_gesamtmodell_get_eml_resolved_functions_info(void)
{
  ...
  *c2_identifier)
{
  ...
  c2_y = c2_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_gesamtmodell), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_gesamtmodell);
  return c2_y;
}
...
/* SFunction Glue Code */
void sf_c2_gesamtmodell_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c2_gesamtmodell_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c2_gesamtmodell(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c2_gesamtmodell\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_gesamtmodell_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc2_gesamtmodellInstanceStruct *chartInstance;
    chartInstance = (SFc2_gesamtmodellInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c2_gesamtmodell(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_gesamtmodellInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c2_gesamtmodell((SFc2_gesamtmodellInstanceStruct*)
    chartInstanceVar);
  initialize_c2_gesamtmodell((SFc2_gesamtmodellInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c2_gesamtmodell(void *chartInstanceVar)
{
  enable_c2_gesamtmodell((SFc2_gesamtmodellInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c2_gesamtmodell(void *chartInstanceVar)
{
  disable_c2_gesamtmodell((SFc2_gesamtmodellInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c2_gesamtmodell(void *chartInstanceVar)
{
  sf_c2_gesamtmodell((SFc2_gesamtmodellInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c2_gesamtmodell(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_gesamtmodell
    ((SFc2_gesamtmodellInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c2_gesamtmodell();/* state var info */
...
extern void sf_internal_set_sim_state_c2_gesamtmodell(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c2_gesamtmodell((SFc2_gesamtmodellInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c2_gesamtmodell(SimStruct* S)
{
  return sf_internal_get_sim_state_c2_gesamtmodell(S);
}

static void sf_opaque_set_sim_state_c2_gesamtmodell(SimStruct* S, const mxArray *
  st)
{
  sf_internal_set_sim_state_c2_gesamtmodell(S, st);
}

static void sf_opaque_terminate_c2_gesamtmodell(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_gesamtmodellInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c2_gesamtmodell((SFc2_gesamtmodellInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc2_gesamtmodell((SFc2_gesamtmodellInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_gesamtmodell(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c2_gesamtmodell(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c2_gesamtmodell(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_gesamtmodell(SimStruct *S)
{
  SFc2_gesamtmodellInstanceStruct *chartInstance;
  chartInstance = (SFc2_gesamtmodellInstanceStruct *)malloc(sizeof
    (SFc2_gesamtmodellInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_gesamtmodellInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c2_gesamtmodell;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_gesamtmodell;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c2_gesamtmodell;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c2_gesamtmodell;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c2_gesamtmodell;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c2_gesamtmodell;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c2_gesamtmodell;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_gesamtmodell;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_gesamtmodell;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_gesamtmodell;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c2_gesamtmodell;
...
void c2_gesamtmodell_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_gesamtmodell(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_gesamtmodell(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_gesamtmodell(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_gesamtmodell_method_dispatcher.\n"
