...
%Besitzt allerdings nur eine Updaterate von $ 40 Hz $.
 ...
 Der Zustand der Geschwindigkeit $ v^n $ ist messtechnisch sehr schwer zu ermitteln. Eine Möglichkeit zur messtechnischen Erfassung wäre die Integration eines Dopplerradars \cite{ras12} auf dem Quadrocopter. Dieser basiert auf dem Doppler-Effekt. Dabei wird ein periodisches Signal ausgesendet und je nach Geschwindigkeit die Periodendauer  gestaucht, bzw. für negative Geschwindigkeiten gestreckt. Anhand der Frequenzänderung des reflektieren Signals, kann so auf die Geschwindigkeit geschlossen werden. Diese Umsetzung bedeutet  einen zusätzlichen Sensor, der wiederum mit Kosten verbunden ist. Es sind somit  Methoden gefragt, die über die vorhandene Sensorik (IMU und Laser) die Geschwindigkeit feststellen.
