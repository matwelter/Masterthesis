...
Der Simulationsaufbau basiert dabei auf dem in Kapitel \ref{sec:Modelbildung} eingeführten Bewegungsmodell. Um die Simulation möglichst realistisch zu gestalten sind die Ausgangsgrößen denen der Realität angenähert. So sind die Beschleunigungswerte als auch die Positionsdaten mit einem weißen Rauschen überlagert. Darüber hinaus wird die Postion nur in einem diskreten Zeitintervall von $ T_l = 25~ms $ aktualisiert. Die Eingangsgrößen des Modells bestehen  aus der Schubvorgabe sowie den Winkeln zur Beschreibung der Orientierung  ($ u = \begin{bmatrix}T &\phi &\theta &\psi \end{bmatrix}^T $). Daran angeschlossen befindet sich die Inversion, welche das System zustandslinearisiert, so dass als neue Eingangsgrößen die Beschleunigungsgrößen in Richtung der n-frame Koordinatensysteme vorgegeben werden.
