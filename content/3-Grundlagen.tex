...
\begin{figure}
	...
	\caption[Node Kommunikation]{Kommunikation von Node1 zu Node2 über ein Topic sowie einem Service}
...
Der wohl größte Vorteil von \gls{ros} ist die ständig wachsende Community. So stellen Forscher aus der ganze Welt ihre Algorithmen und Hardwareabstraktionen zur Verfügung. Dadurch ist es möglich bei der Erstellung einer Roboteranwendung auf Bausteine zurück zugreifen, die ohne diese Plattform selbst zu implementieren wären.
