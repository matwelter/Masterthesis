...
\begin{itemize}
	\item{
\textbf{Vorgang 1,} Punktekorrespondenz.
...
\item \textbf{Vorgang 2,} Bestimmung des Rotationswinkel $\Delta\psi^o$ und der Translation $T$
...
\item \textbf{Vorgang 3,} Ermittlung der Summe der quadratischen Fehler $E(M^o_z(\Delta\psi^o),T)$ 
...
\item \textbf{Vorgang 4,} Vergleich von $E(M^o_z(\Delta\psi^o),T)$ mit Schwellwert $ E_{max} $ 
