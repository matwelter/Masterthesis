...
Der Schub der Rotoren ist Anhand der Drehzahl $n_i$ der Rotorblätter individuell einstellbar. Somit lassen sich die Kräfte $ F_i $ die an den Endpunkte der Quadrocopterarme der Länge $ l $ wirken vorgeben.
...
Zum Einsatz kommt der AscTec Pelican der Firma \gls{asctec} \cite{hmpgasctec}. Dieser Quadrocopter ist eine spezielle Entwicklung für die Forschung. Seine Turmstruktur ermöglicht eine einfache Integration zusätzlicher Sensoren und Nutzlasten. Durch die Flexibilität im Aufbau ist das Ziel dieses Teilkapitels, einen Überblick zur Position der einzelnen Komponenten zu geben. Begleitend zum Text ist der Aufbau in Abbildung \ref{fig:hardwareaufbau} dargestellt.\\
	...
	\begin{figure}
		...
		\caption[Hardwareaufbau]{Hardwareaufbau des Quadrocopter}
...
\begin{figure}
	...
	\caption[Kommunikationsstruktur]{Kommunikationsstruktur des Quadrocopters}
