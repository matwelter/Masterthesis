...
Da der Einsatzbereich im Indoorbereich liegt, ist der Drucksensor zur Höhenbestimmung in geschlossenen Räumen nicht geeignet. Er liefert erst ab einer Höhe von 5m zuverlässige Werte. Daher wurde in einer vorangegangen Arbeit von Jan Kallwies (lITERAURVERWIES JAN) die Hardware um ein Modul zur Messung der Höhe im Indoorbereich erweitert. Auf diesem Modul befinden sich zwei Infrarotsensoren für den Nahbereich. Beide zusammen decken einen Bereich von 4 cm bis 142 cm ab. Erweitert wird der Messbereich durch einen Ultraschallsensor für Entfernungen von bis zu 5 m. Aus diesen drei Sensordaten wird über einen Extended-Kalman-Filter die Flughöhe bestimmt. Eine genaue Beschreibung dieses Fusionsfilters kann in der Arbeit von Jan Kallwies [LITERATURVERZEICHNIS] nachgelesen werden. Da in dieser Arbeit die Navigation in der horizontale Ebene den Schwerpunkt darstellt, wird dieses Modul in dieser Arbeit nicht weiter behandelt.
...
Derzeit ist bekannt, wie die einzelnen Komponenten untereinander vernetzt sind. Im weiteren Verlauf der Arbeit lässt sich nachvollziehen, an welchen Stellen die Anwendungen implementiert werden und über welche Verbindungen sie miteinander kommunizieren. 
